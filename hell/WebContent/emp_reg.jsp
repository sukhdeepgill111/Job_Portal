...
<HTML>
<HEAD>
<FONT SIZE="4" COLOR="blue" FACE="roman">Employer Information
	Page : </FONT>
...
<BODY BGCOLOR="#4EE2EC">
	<form NAME="CREATEACCTFORM" action="Emp_reg" METHOD="POST">
		<table width="780" border="0" align="center" cellpadding="0"
			...
			<table width="100%" border="0" cellpadding="7" cellspacing="0"
				...
				<tr>
					<td colspan="2" align="right" valign="top"
						...
						style="padding: 0px 10px 0px 0px;"><span class="txt_orange">*</span>
						Required fields</td>
				...
				<tr>
					...
					<td valign="top"><input maxlength="32" size="30"
				...
				<tr>
					...
					<td>
						...
						<table cellspacing="0" cellpadding="0" border="0"
							...
							<tr>
								<td><input type="text" name="web" value="">
						</table>
			...
			<form method="post" action="done_emp.jsp">
				<table cellspacing="0" cellpadding="0" border="0"
					id="currentloc_border">
					<tr>
						<td><BR>&nbsp<input type="submit" value="LOGIN">
				</table>
